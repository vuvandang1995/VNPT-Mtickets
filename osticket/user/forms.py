...
class RegistrationForm(forms.Form):
    ...
    # lưu tài khoản User
    def save(self):
        u = Users(fullname=self.cleaned_data['fullname'], username=self.cleaned_data['username'], email=self.cleaned_data['email'], phone=self.cleaned_data['phone'], password=self.cleaned_data['password'], created=timezone.now(), token=binascii.hexlify(os.urandom(24)).decode("utf-8"))
        u.save()
        return u
